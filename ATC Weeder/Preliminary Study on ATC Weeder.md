...
### Electrical Weeding
The first patent of an electrical weeding apparatus actually dates back to the end of the 19th century REFRX. However, only recently did the agricultural technology community begin to really reconsider electrical weeding as a true candidate for precision weed control. As in laser weeding, this approach relies on increasing the temperature of the plant through "indirect" means (in contract with proper thermal methods). The electric current passed to the plant transforms into heat energy inside the plant's cell. This results in the vaporization of water and other volatile liquids, leading to a pressure buildup that ruptures the cells' membranes both in the roots and the foliage. In term, the plant will die or at least have its growth suppressed REFRX.

There exist two main modes of action for electrical weeding:

#### Continuous Electrode-Plant Contact
This method is not really adapted for spot applications since it requires long duration ("continuous") contact between the electrodes and the plant. It consists of connecting electrodes to the weed, and sending a low voltage (12-48 V) through the plant, which leads to the disruption of its physiological processes REFRX. Since this method requires between minutes to hours for it to really destroy weeds, we consider that it is not adapted as a replacement to precision spraying.

#### Spark Discharge
This method consists of killing through high-voltage electrical pulses, which is quite adapted for precise spot destruction. The method consists of placing an electrode in contact or nearby the weed and generating a high-voltage electrical pulse (5000-150000 V) which would traverse the plant and lead to cell rupture as described previously. This method has immediate effect in that the weed shows signs of damage within minutes or hours after treatment, whereby the treatment can last a fraction of a second REFRX Bloomer et al.  

The effectiveness of this method depends on a number of factors, in particular (1) weed size and age, (2) weed species, and (3) moisture levels. REFRX Mizuno et al. showed that small plants (40–60 mm height, 1–3 mm stem diameter) could be destroyed by one spark discharge of 0.14 J energy and very large plants (800–1,200 mm height, 10–15 mm stem diameter) with repeated pulses totaling only 2 J REFRX.

#### Energy Requirements
REFRX Bloomer et al. provide an interesting comparison in energy requirements between different weed control methods. TABREFRX shows that electrical methods are highly competitive and much more energy-efficient than the other methods explored in this report -- and even to chemical herbicides, when the energy required for producing the chemicals is taken into consideration. This result suggests that electrical weeding using high voltage pulses is an interesting alternative to chemical approaches. 

**Pros**
Electrical weeding presents a number of positive points that make it an interesting approach in comparison to chemical weeding and the previously presented approaches:
1. Relatively low energy requirements: As shown in TABREFRX, electrical pulsing may actually be much more efficient than other methods in terms of energy consumption.
2. Safer thermal approach: One of the main shortcomings of flaming and laser weeding is the fire hazard associated to them, particularly if deployed in an autonomous fashion without supervision. Electrical weeding, although also relying on thermal destruction of the weeds, does not seem to present the same fire hazard since the heating of the plant happens only when it enters in contact with the electrode. As such, a carefully guided electrode that only enters in contact with the plants that need to be killed may actually be a safe solution.
3. Potentially more eco-friendly: Scientific studies on the impact of electrical weeding on the health of the soil and its living organisms have conflicting results -- and most of them pertain to continuous electrode-plant contact, which is not really the method of interest to us REFRX. However, in all cases, it seems that this approach is generally more eco-friendly than chemical spraying and better preserves the health of the soil and the ecosystem.

**Cons**
There are some points to take into consideration when developing and deploying an electrical weeding system:
1. Difficulty of precise contact: Since pulsing only works when the electrode is very close or in contact with the weed, it is important to be very precise in approaching the electrode of the plant of interest. This can be an important challenge in automation -- people working on the robotic arm for pruning know this very well. 
2. Difficulty for intra-row weeding: In relation to the previous point, electrical pulse weeding can be very difficult to apply in dense and tall crops, or when the weeds are in the row of crops. This requires precise navigation of the electrode towards the weed. Furthermore, the electrical pulse traversing the weed may be transmitted to nearby crops if their organs are touching thus damaging the crops (what we call "non-selective risk").
3. Variable effectiveness: If the electrode is only in contact with the upper parts of the plant, the current may not reach the roots with enough energy to actually destroy them. For certain species of weeds, destroying the weeds is crucial otherwise they will regrow and propagate. 
4. Specialized devices and associated maintenance: Such a system requires high-voltage generators and electrodes which may be expensive to purchase and maintain. Furthermore, electrodes may degrade over time, in particular with frequent use. This is a point to take into consideration.

## Synthesis
Based on the readings we conducted, there are some points that started to become clearer:
- **No holy grail for precision weeding:** It is clear that there *is no one method* that works for all weed species, all conditions and all use cases. While in some parcels, mechanical hoeing may be the best method, in others it may well be chemical spraying or laser weeding. There are indeed too many variables to take into consideration, starting from the type of the terrain, to the crop and weed species, to the farmers' location and preferences.
- **Chemical spraying still seems to be the most versatile approach:** The alternative approaches presented previously all present some positive aspects. However, chemical spraying still appears to be the most easily applicable and the most efficient in terms of usage. For example, the same spraying apparatus can be used with different types of chemical products depending on the farmer's need. However, for mechanical weeding, each mechanical system may need to be dismounted to be replaced by another one depending on the needs of the day.
- **Chemical precision spraying is the most mature technology:** I would like to emphasize again that I am talking about *automated spot weeding*. Mechanical weeding may be much older and more mature than chemical spraying, however in terms of *precise site-specific* applications it does not seem to be the case. Thermal approaches are not at all applied yet in automated ways for field crops, and laser and electrical approaches have very few actors on the market working on them. In terms of technological maturity, spot spraying appears to be the most advanced approach with the biggest number of teams working on developing solutions.
- **Some approaches require important technical skills for development:** All of the above presented approaches require highly specialized individuals and teams for their development. It is more so in some methods than others. A ranking in terms of technicality from the most to least complex may resemble something like this: (1) laser, (2) electrical, (3) thermal, (4) mechanical.
- **Spot spraying for field crops, or other farming methods?** I would say that methods like flaming or hot water/foam weeding, or even electrical weeding, may be hard to motivate for large intensive field cropping (maize, soybean, sugar beet, etc.). For such intensive farming practices, chemical spraying may still be very much more efficient than our novel approaches. Furthermore, intensive farmers may not always see the interest in moving away from chemical approaches. However, do we want to develop a product for other venues, such as horticulture, viticulture, or organic field crops? If yes, then this is where ATC methods would probably shine.
- **Heavily established actors:** A more detailed review of the competitors would make this even clearer. However, our first impression is that there are already very well established (even "old") actors in each of the ATC approaches presented previously, with a number of years of experience. Some have a multitude of patents securing their methods (*Carbon Robotics*). Some are already at a second generation of their systems (*Carbon Robotics*, *WeedSpider*, etc.). The question that we should ask: can we enter late in these markets?
